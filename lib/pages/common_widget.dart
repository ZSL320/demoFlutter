...
//  */
// void Function()? _onTapFunc;
// void Function()? _onDoubleTapFunc;
// void Function()? _onLongPressFunc;
//
// class CommonWidget {
//   late Widget _widget;
//   CommonWidget(this._widget);
//
//   ///add padding属性
...
//
//   ///透明度 0 是完全透明 1 完全不透明
//   CommonWidget opacity(
//       {Key? key, @required double? opacity, alwaysIncludeSemantics = false}) {
//     _widget = new Opacity(
//         key: key,
//         opacity: opacity!,
...
//     _widget =
//         new AspectRatio(key: key, aspectRatio: aspectRatio, child: _widget);
//     return this;
//   }
//
//   ///矩阵转换
...
//     _widget =
//         new SizedBox(key: key, width: width, height: height, child: _widget);
//     return this;
//   }
//
//   ///设置最大最小宽高布局
...
//         maxHeight: maxHeight);
//     _widget =
//         new ConstrainedBox(key: key, constraints: constraints, child: _widget);
//     return this;
//   }
//
//   ///限定最大宽高布局
...
//     maxHeight = double.infinity,
//   }) {
//     _widget = new LimitedBox(
//         key: key, maxWidth: maxWidth, maxHeight: maxHeight, child: _widget);
//     return this;
//   }
//
//   ///百分比布局
...
//
//   ///缩放布局
//   CommonWidget fittedBox(
//       {Key? key, fit = BoxFit.contain, alignment = Alignment.center}) {
//     _widget =
//         new FittedBox(key: key, fit: fit, alignment: alignment, child: _widget);
//     return this;
//   }
//
//   ///旋转盒子 1次是90度
...
//   }) {
//     _widget =
//         new RotatedBox(key: key, quarterTurns: quarterTurns, child: _widget);
//     return this;
//   }
//
...
//   }) {
//     _widget = new DecoratedBox(
//         key: key, decoration: decoration, position: position, child: _widget);
//     return this;
//   }
//
//   ///圆形剪裁
...
//     _widget = new ClipOval(
//         key: key, clipper: clipper, clipBehavior: clipBehavior, child: _widget);
//     return this;
//   }
//
//   ///圆角矩形剪裁
...
//
//   ///添加点击事件
//   CommonWidget onTap(void Function()? func, {Key? key}) {
//     _onTapFunc = func;
//     _widget = new GestureDetector(
//       key: key,
//       child: _widget,
...
//
//   ///双击
//   CommonWidget onDoubleTap(void Function()? func, {Key? key}) {
...
//
//   ///长按
//   CommonWidget onLongPress(void Function()? func, {Key? key}) {
